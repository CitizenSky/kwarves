...
export const I18N = {
  de: {
    ...
    sidebar_rule_text: "Der HZ-Filter zeigt nur KONSERVATIVE_HZ und OPT_HZ_INNEN. ZU_HEISS ist kein HZ-Kandidat.",
    ...
    kpi_violet: "HZ",
    kpi_violet_sub: "echte HZ",
    filter_all: "Alle",
    filter_green: "Gruen",
    filter_yellow: "Orange",
    filter_spc_prep: "SPC Prep",
    filter_vvt: "VVT Shortlist",
    filter_ttv: "TTV / Multi-Planet Review",
    vvt_queue_title: "VVT Shortlist",
    vvt_queue_sub: "ExoFOP-nahe Kandidaten mit echten Lichtkurven- und Vetting-Daten.",
    vvt_candidates_empty: "Keine VVT-Shortlist-Kandidaten.",
    filter_red: "Rot",
    filter_violet: "HZ",
  ...
  en: {
    ...
    sidebar_rule_text: "The HZ filter shows only KONSERVATIVE_HZ and OPT_HZ_INNEN. ZU_HEISS is not an HZ candidate.",
    ...
    filter_ttv: "TTV / Multi-Planet Review",
    vvt_queue_title: "VVT Shortlist",
    vvt_queue_sub: "ExoFOP-near candidates with real light-curve and vetting data.",
    vvt_candidates_empty: "No VVT shortlist candidates.",
    filter_red: "Red",
    filter_violet: "HZ",
    ...
    toast_filter_hz: "Filtered to HZ.",
  ...
  fr: {
    ...
    sidebar_rule_text: "Le filtre HZ affiche seulement KONSERVATIVE_HZ et OPT_HZ_INNEN. ZU_HEISS n'est pas un candidat HZ.",
    ...
    filter_ttv: "TTV / Multi-Planet Review",
    vvt_queue_title: "VVT Shortlist",
    vvt_queue_sub: "Candidats proches d'ExoFOP avec courbes de lumiere et donnees de vetting reelles.",
    vvt_candidates_empty: "Aucun candidat dans la VVT Shortlist.",
    filter_red: "Rouge",
    filter_violet: "HZ",
    ...
    toast_filter_hz: "Filtre HZ actif.",
